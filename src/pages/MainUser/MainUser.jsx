  ...
  return (
    <div>
      ...
      <main className="main-content">
        <h2 className="saludo">¡Hola, Nombre del Usuario! Estamos felices de verte de nuevo.<br />¿Listo para continuar tu camino hacia el equilibrio emocional?</h2>
        ...
        <div className="cuadros">
          <div className="cuadro-contacto">
            <img src={contactImg} alt="Profesional" />
            <p>Contacta con un profesional</p>
            <button>Contactar</button>
          </div>

          <div className="cuadro-contacto">
            <img src={volunteerImg} alt="Voluntario" />
            <p>Contacta con un voluntario certificado</p>
            <Link to="/chat">
              <button>Chat</button>
            </Link>
          </div>
